 ...
 */
public class InqSubscriberEndpoint extends InqMediaEndpoint {
  private final static Logger log = LoggerFactory.getLogger(InqSubscriberEndpoint.class);

  private boolean connectedToPublisher = false;

  private InqPublisherEndpoint publisher = null;
  ...
  public void setPublisher(InqPublisherEndpoint publisher) {
