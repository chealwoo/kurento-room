...
function idsearch() {
	console.log('searching video call ...' + $('#chatId').val());
...
function searchResponse(message) {
	// Update number of record field
	console.log('searchResponse answer received from server. Processing ...');

	$('#totalVideos').text(message.count);
}
