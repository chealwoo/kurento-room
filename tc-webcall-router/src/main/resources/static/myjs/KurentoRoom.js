    ...
    function initWebRtcPeer(sdpOfferCallback) {
        if (local) {
        	 var options = {
                 ...
                 iceServers: [{ urls: 'turn:104.198.227.105', username:'Tckurento', credential:'Tckurento' }]
             }
            // var s1 = "104.198.227.105:3478";
            // var s2 = "104.155.160.103:3478";
            // var configuration = recursive({ iceServers: {url:"turn:"+s1,credential:"Tckurento",username:"Tckurento",urls:["turn:"+s1]},{url:"turn:"+s2,credential:"Tckurento",username:"Tckurento",urls:["turn:"+s2]}] }, options.configuration);
