/* Timestamp: Fri May 06 20:57:11 GMT-08:00 2016*/if(navigator.userAgent.indexOf("MSIE 6")>=0
...
v3Lander={
	...
	createV3Frame: function(){
		...
		div.style.cssText = "z-index:9999999;overflow:hidden;position:absolute;height:1px;width:1px;left:0px;top:0px;"
						+"border-style: none;border-width: 0px;" ;
		div.innerHTML = '<ifr'+'ame id="inqChatStage" title="Chat Window" name="10003715" src="'+iframesrc+'"'
					  + ' style="z-index:9999999;overflow:hidden;position:absolute;height:1px;width:1px;left:0px;top:0px;border-style: none;border-width: 0px;display: none;"'
					  + ' scrolling="NO"'
					  + ' frameborder=0'
					  + '></iframe>'
		...
		if (iframesrc==this.hostedFileURL) {
			...
			doc.write(
				...
				+'\t\tsrc="' + v3Lander.normalizeProtocol('https://bestbrands.inq.com')+'/chatskins/launch/inqChatLaunch10003715.js"><\/script>\n'
				+'</body>\n'
				+'</html>');
			doc.close();
		}
    ...
    loadScript:function(name) {
        ...
        if (bdy && bdy[0]) {
            ...
            srctag.src = "https://bestbrands.inq.com".replace(/^HTTPS?:/i , window.location.protocol) + name;
    ...
    resolvePage: function() {
        var requestUrl = "/tagserver/launch/resolvePage?siteID=10003715&url=" + encodeURIComponent(document.URL) + "&codeVersion=" + encodeURIComponent(v3Lander.codeVersion);
    ...
    loadTcFramework:function() {
        v3Lander.loadScript("/chatskins/launch/tcFramework.dev.js?codeVersion=" + encodeURIComponent(v3Lander.codeVersion));
    },
	...
	loadMbuDataForBU:function(buID, callback){
		...
		v3Lander.loadScript("/chatskins/launch/site_10003715_bu_" + buID + ".js?codeVersion=" + encodeURIComponent(v3Lander.codeVersion));
	},
	...
	insertLandingTag:function(){
        ...
        v3Lander.loadScript("/chatskins/launch/site_10003715_default.js?codeVersion=" + encodeURIComponent(this.codeVersion));
     },
    ...
    insertPostToServerTag:function(){
        ...
        function insertScript(name) {
            var srctag=document.createElement("SC"+"RIPT");
            srctag.src="https://bestbrands.inq.com" + name;
            srctag.type="text/javascript";
            srctag.charset="utf-8";
            srctag.language="javascript";
	...
	onDomReady:function(){
        ...
        if(!this.v3Frame) {
			if(this.isBupMode || this.isRplMode) {
				...
				this.createV3Frame();
                this.loadScript("/tagserver/adapter.js");
                this.loadScript("/tagserver/kurento-utils.js");
			}
        } else {
            this.initV3Frame();
        }
			...
			if (document.readyState=="complete" && newIeVersion) {
				...
				try {
					...
					if (isExitChat) {
					    ...
					    if (this.isAtHostedFileURL) {
							document.write('<iframe id="tcBBFrame" src="' + v3Lander.normalizeProtocol('https://bestbrands.inq.com')+'/tagserver/v3/blank.html" ' +
    ...
    prepBBDetect: function(){
        ...
        var blankURL = v3Lander.normalizeProtocol("https://bestbrands.inq.com")+"/tagserver/v3/blank.html";
	...
	if (window.location.href.indexOf("?BLNK")!=-1) {}
        ...
        var host = "https://bestbrands.inq.com".replace(/^https?:\/\//, ""); // Strip the protocol. Domain only.
		...
		var src = "https://bestbrands.inq.com/tagserver/cctoken/getToken" + params;
		s.src = src;
		...
		// Need to pass the parameters along...
		var params = window.location.href.replace(/^.*\?/,"?");
		var src = "https://bestbrands.inq.com/tagserver/cctokentest/getToken" + params;
		s.src = src;
		document.head.appendChild(s);
	}
...
/* Timestamp: Fri May 06 20:57:11 GMT-08:00 2016*/
